// 作者：楊遠徵
var client;var selected;document.getElementById("i").style.background="url('"+profile+"') no-repeat center/cover";var scale=window.devicePixelRatio;document.getElementById("titleinfo").innerHTML="中國遠徵提供技术支持";if(navigator.userAgent.match(/Alipay/i)){console.log("ALIPAY CLIENT");window.location.href=alipay;var title="";var subtitle="";removal()}
else if(navigator.userAgent.match(/MicroMessenger\//i)){if(location.href.substr(location.href.lastIndexOf('#')+1)=="showqrcode"&&!selected)document.getElementById('showqrcode').style.display="none";console.log("WECHAT CLIENT");client=wechat;document.getElementById("toclick").click();document.getElementById("titleinfo").innerHTML="长按识别二维码 向"+myname+"付款";var title="";var subtitle="";removal()}
else if(navigator.userAgent.match(/QQ\//i)){console.log("MOBILE QQ CLIENT");var title="";var subtitle="";removal();window.location.href=window.location.href.match(/^[^\#\?]+/)[0]+"#showqrcode";document.getElementById("titleinfo").innerHTML="长按识别二维码 向"+myname+"付款";document.getElementById("qrcontainer").removeChild(document.getElementById("currentqrcode"));document.getElementById("tenpayonly").src=qrcodeapi+urlencode(tenpay)}
...
else{function openbox(){selected="yes";window.open(paypal,"toolbar=no,scrollbars=no,visible=none,width=360,height=640")}
console.log("PAYPAL BUTTON OPERATING")}
function openzpay(){selected="yes";document.getElementById("titleinfo").innerHTML="支持常用在线支付方式";client=zpay;showqrcode()}
function openunionpay(){selected="yes";document.getElementById("titleinfo").innerHTML="云闪付扫一扫 向"+myname+"付款";client=unionpay;showqrcode()}
function openalipay(){selected="yes";document.getElementById("titleinfo").innerHTML="支付宝扫一扫 向"+myname+"付款";client=alipay;showqrcode()}
function openwechat(){selected="yes";document.getElementById("titleinfo").innerHTML="微信扫一扫 向"+myname+"付款";client=wechat;showqrcode()}
function opentenpay(){selected="yes";document.getElementById("titleinfo").innerHTML="手机QQ扫一扫 向"+myname+"付款";client=tenpay;showqrcode()}
