...
function openzpay(){selected="yes";document.getElementById("titleinfo").innerHTML="支持银行卡、支付宝、微信等常用支付";client=zpay;showqrcode()}
function openunionpay(){selected="yes";document.getElementById("titleinfo").innerHTML="云闪付扫一扫 向"+myname+"支付";client=unionpay;showqrcode()}
function openalipay(){selected="yes";document.getElementById("titleinfo").innerHTML="支付宝扫一扫 向"+myname+"支付";client=alipay;showqrcode()}
function openwechatpay(){selected="yes";document.getElementById("titleinfo").innerHTML="微信扫一扫 向"+myname+"支付";client=wechatpay;showqrcode()}
